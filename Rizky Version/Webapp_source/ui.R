  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tab_inputfeatures <- tabItem(tabName = "Feature_plot_page",
                                   ...
                                   br(),
                                   selectInput("FeaturePlot_GeneInput", "Select Gene:",choices = NULL,selected = NULL,multiple = T,maxItems = 10),
      ...
      tab_violin <- tabItem(tabName = "VlnPlot",
                            h2("Violin Plot"),
                            br(),
                            selectInput("VlnPlot_GeneInput", "Select Gene:",choices = NULL,selected = NULL,multiple = T,maxItems = 10),
